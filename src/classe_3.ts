...
console.log(`O valor do imposto Humano é: ${pessoafísica.calculoImposto()}`);
...
try {
    ...
    pessoajuridica.rendaAnual = 10000
 ...
 console.log(pessoajuridica);
try {
     pessoafísica.nome = 'Alek2'
    //  pessoafísica.funcionario = 340
        pessoafísica.rendaAnual = 50000
